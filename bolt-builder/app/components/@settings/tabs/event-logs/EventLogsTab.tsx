...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with Zyraxon AI Builder
      doc.setFontSize(12);
      doc.setFont('helvetica', 'normal');
      doc.text('Zyraxon AI Builder - AI Website Builder', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by Zyraxon AI Builder', margin, doc.internal.pageSize.getHeight() - 10);
