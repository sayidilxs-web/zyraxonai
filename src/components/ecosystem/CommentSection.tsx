    ...
    <div style={{ marginTop: 24 }}>
      ...
      {auth.isAuthenticated && auth.user ? (
        <div style={{ display: 'flex', gap: 12, marginBottom: 24 }}>
          <img src={auth.user.avatarUrl || https://github.com/.png} alt="" style={{ width: 36, height: 36, borderRadius: '50%', background: '#21262d' }} />
          <div style={{ flex: 1 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        {comments.length === 0 ? (
          ...
          <div key={c.id} style={{ display: 'flex', gap: 12 }}>
            <img src={c.avatarUrl || https://github.com/.png} alt="" style={{ width: 32, height: 32, borderRadius: '50%', background: '#21262d', flexShrink: 0 }} />
            <div style={{ flex: 1 }}>
